...
async function fetchPreviewData(slug: string) {
  let res = await fetch(
    "https://70dmq76f.api.sanity.io/v2023-07-14/data/query/production?query=*%5B_type+%3D%3D+%22products%22+%26%26+slug.current%3D%3D+%22cameryn-sash-tie-dress%22%5D"
  );
  return res.json();
}
